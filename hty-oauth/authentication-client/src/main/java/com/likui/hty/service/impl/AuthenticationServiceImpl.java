...
import com.likui.hty.client.AuthenticationFeginApi;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Autowired
    private AuthenticationFeginApi authenticationFeginApi;
    ...
    public Result authenticate(String authentication, String url, String method) {
        return this.authenticationFeginApi.auth(authentication, url, method);
    }
