...
@Component
@FeignClient(name = "authentication-server", fallback = AuthenticationFeginApi.AuthenticationFeginApiFallback.class)
public interface AuthenticationFeginApi {
    /**
     * 调用签权服务，判断用户是否有权限
     *
    ...
    @Component
    class AuthenticationFeginApiFallback implements AuthenticationFeginApi {
        /**
         * 降级统一返回无权限
         *
         * @param authentication
